...
namespace MercaderSG
{
    ...
    public partial class DesbloquearUsuario : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            UsuarioGB.TabIndex = 3;
            UsuarioGB.TabStop = false;
            UsuarioGB.Text = "Seleccioanar Usuario";
            // 
            // CancelarBtn
            // 
            _CancelarBtn.Image = My.Resources.Resources.CancelBtn;
            _CancelarBtn.Location = new Point(185, 74);
            ...
            // DesbloquearPB
            // 
            DesbloquearPB.Image = My.Resources.Resources.DesbloquearG;
            ...
            _AceptarBtn.Location = new Point(97, 74);
            ...
            Load += new EventHandler(DesbloquearUsuario_Load);
            FormClosing += new FormClosingEventHandler(DesbloquearUsuario_FormClosing);
            KeyDown += new KeyEventHandler(DesbloquearUsuario_KeyDown);
            ResumeLayout(false);
        }
