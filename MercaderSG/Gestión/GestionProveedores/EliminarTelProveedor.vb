...
Public Class EliminarTelProveedor
    Public CodProv As Integer

    Private Sub EliminarTelProveedor_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub EliminarTelProveedor_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        End If
            ...
            Help.ShowHelp(Me, pathchm, HelpNavigator.TopicId, "111")
        End If
    End Sub
