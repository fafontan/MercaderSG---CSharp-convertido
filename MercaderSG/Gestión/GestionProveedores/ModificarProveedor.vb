...
Public Class ModificarProveedor
    ...
    Private Sub ModificarProveedor_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Dim Proveedor As ProveedorEN = ProveedorRN.ObtenerProveedor(CuitSel)
    ...
    Private Sub AceptarBtn_Click(sender As System.Object, e As System.EventArgs) Handles AceptarBtn.Click
        ...
        Proveedor.CodLoc = LocalidadCMB.SelectedValue
...
#Region "Validaciones"
    ...
    Private Sub RazonSocialTxt_TextChanged(sender As System.Object, e As System.EventArgs)
        ErrorP.SetError(RazonSocialTxt, "")
    End Sub

    Private Sub CuitTxt_TextChanged(sender As System.Object, e As System.EventArgs)
        ErrorP.SetError(CuitTxt, "")
    End Sub

    Private Sub CorreoElectronicoTxt_TextChanged(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub ModificarProveedor_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.F1 Then
            ...
            Help.ShowHelp(Me, pathchm, HelpNavigator.TopicId, "125")
        End If
    End Sub
...
#Region "Idioma y TT"
    ...
    Public Sub AplicarIdioma()
        Me.Text = My.Resources.ArchivoIdioma.ModificarProveedorFrm
