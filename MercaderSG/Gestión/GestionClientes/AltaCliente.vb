...
Public Class AltaCliente
    ...
    Private Sub AltaCliente_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        CargarTT()
        AplicarIdioma()
        CargarFoco(DatosGB)
    ...
    Private Sub AceptarBtn_Click(sender As System.Object, e As System.EventArgs) Handles AceptarBtn.Click
        ...
        Catch ex As WarningException
            ...
            If ex.Message = My.Resources.ArchivoIdioma.ClienteExistente Then

                If PuedeModificar = True Then
                    Dim Resultado As DialogResult = MessageBox.Show(My.Resources.ArchivoIdioma.ModificarCliente & CuitTxt.Text & My.Resources.ArchivoIdioma.Pregunta, My.Resources.ArchivoIdioma.MsgBoxModificarCliente, MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
...
#Region "Validaciones"
    ...
    Private Sub AltaCliente_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.F1 Then
            ...
            Help.ShowHelp(Me, pathchm, HelpNavigator.TopicId, "100")
        End If
    End Sub
...
#Region "Idioma y TT"
    ...
    Public Sub AplicarIdioma()
        Me.Text = My.Resources.ArchivoIdioma.AltaClienteFrm
