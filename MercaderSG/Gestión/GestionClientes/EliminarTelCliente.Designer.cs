...
{
    [DesignerGenerated()]
    public partial class EliminarTelCliente : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            _CancelarBtn.Location = new Point(204, 160);
            ...
            _AceptarBtn.Location = new Point(116, 160);
            ...
            TelefonosGB.Size = new Size(374, 138);
            ...
            _TelefonosDG.Columns.AddRange(new DataGridViewColumn[] { CodTelCAB, CodCliCAB, NumeroCAB });
            ...
            _TelefonosDG.Size = new Size(364, 113);
            ...
            // CodCliCAB
            // 
            CodCliCAB.DataPropertyName = "CodEn";
            CodCliCAB.HeaderText = "C.Cliente";
            ...
            KeyPreview = true;
            MaximizeBox = false;
            Name = "EliminarTelCliente";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Eliminar número de teléfono - MercaderSG";
            TelefonosGB.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)_TelefonosDG).EndInit();
            Load += new EventHandler(EliminarTelCliente_Load);
            KeyDown += new KeyEventHandler(EliminarTelCliente_KeyDown);
            ResumeLayout(false);
        }
