...
{
    public class NotaPedidoRP : ReportClass
    {
        public NotaPedidoRP() : base()
        {
        }
        ...
        public override string FullResourceName
        {
            get
            {
                return "MercaderSG.NotaPedidoRP.rpt";
            }
    ...
    public class CachedNotaPedidoRP : Component, ICachedReport
    {
        public CachedNotaPedidoRP() : base()
        {
        }
