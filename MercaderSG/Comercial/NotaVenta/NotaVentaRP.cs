...
{
    public class NotaVentaRP : ReportClass
    {
        public NotaVentaRP() : base()
        {
        }
        ...
        public override string FullResourceName
        {
            get
            {
                return "MercaderSG.NotaVentaRP.rpt";
            }
    ...
    public class CachedNotaVentaRP : Component, ICachedReport
    {
        public CachedNotaVentaRP() : base()
        {
        }
